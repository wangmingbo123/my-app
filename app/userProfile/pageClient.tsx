...
export default function JobSeekerProfile({ user3 }: JobSeekerProfileProps) {
  const [currentPlan, setCurrentPlan] = useState<string | null>(null)

  console.log("user3 form server start ")
  console.log(user3)
  console.log("user3 form server end ")
    ...
    <div className="container mx-auto p-4">
      ...
      <Card className="mb-8">
        <CardHeader className="flex flex-row items-center gap-4">
          ...
          <div>
            {/* revice success */}
            <CardTitle className="text-2xl">{user3.name}</CardTitle>
